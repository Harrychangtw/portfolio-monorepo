...
接著，為了改善現有防禦機制迭代成本過高的問題，我提出了一個「免微調」的檢索式防禦框架 FORTRESS，用單獨一個 Instruction-Tune 模型驅動語意檢索及動態的困惑度分析。這篇論文已發表於 TMLR。
...
**教授中右 (陳尚澤教授)：** 可以解釋一下 TMLR 那篇論文在做什麼嗎？
...
**教授中左（黎士瑋教授）：** 我有看到你有個 AAAI 教育影片。AAAI 是一個很不錯的會議，可不可以分享一下那時候投稿的內容？
...
**教授左 (陳祝嵩教授)：** 我比較好奇的是你與中央大學蔡宗翰教授的互動方式。
