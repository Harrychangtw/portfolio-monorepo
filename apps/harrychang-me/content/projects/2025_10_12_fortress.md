...
description: "FORTRESS is a training-free LLM safety system from my TMLR paper. It combines vector retrieval and dynamic perplexity analysis to create a scalable, high-performance defense that is over 5x faster than existing classifiers."
...
featured: true
locked: false
tooltip: "First-author TMLR paper on a fast, training-free LLM safety system."
...
Today, I'm excited to introduce a new paradigm in LLM safety and my latest first-author research paper published in TMLR: **FORTRESS: Fast, Orchestrated Tuning-free Retrieval Ensemble for Scalable Safety**. This article provides a high-level overview, but for a full technical breakdown, the complete paper is available on [OpenReview](https://openreview.net/pdf?id=lCn7RT9DGq).
...
- If the retrieved prompts are homogeneous (e.g., all labeled `unsafe`), the system prioritizes the strong semantic signal.
...
I am deeply grateful to my advisor, Prof. Tsai, for his unwavering support for this project. I also want to thank AK for his early mentorship, which provided me with the academic foundation to pursue this research independently. Finally, I appreciate the constructive feedback from the TMLR reviewers, which helped strengthen the paper significantly.
