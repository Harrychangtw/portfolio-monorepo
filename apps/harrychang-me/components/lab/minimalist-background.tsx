      ...
      >
        ...
        >
          ...
          <div 
            ...
            style={{
              ...
              boxShadow: 'inset 0px 2px 20px 0px hsl(var(--foreground)), 0px -10px 50px 1px hsl(var(--foreground) / 0.5)',
            }}
          />
        </motion.div>
        ...
        >
          ...
          <div 
            className="absolute inset-0 rounded-[100%]"
            style={{
              background: 'radial-gradient(ellipse at center top, hsl(var(--foreground) / 0.3) 0%, hsl(var(--foreground) / 0.08) 20%, hsl(var(--foreground) / 0.03) 40%, transparent 70%)',
              filter: 'blur(40px)',
            }}
          />
        </motion.div>
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(180deg, hsl(var(--background)) 0%, hsl(var(--background) / 0) 100%)',
          }}
        />
      </motion.div>
