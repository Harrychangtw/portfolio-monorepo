        ...
        <section className="relative w-full min-h-[100svh] flex flex-col justify-center overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-4xl mx-auto px-4 md:px-6 text-center -translate-y-12 md:-translate-y-20">
            ...
            >
              ...
              <div
                className="hidden sm:block relative h-14 group"
              ...
              >
                <input
                  ...
                  readOnly
                  placeholder={
                    t("lab.heroEmailPlaceholder", "common") ||
                    "Your Email Address"
                  }
                ...
                />
                <button className="absolute right-2 top-2 bottom-2 bg-foreground text-background rounded-md px-6 font-medium hover:bg-foreground/90 transition-colors">
              ...
              >
                ...
                />
                <button className="w-full h-12 bg-foreground text-background rounded-lg font-medium hover:bg-foreground/90 transition-colors">
                  {t("lab.applyNow", "common")}
                </button>
              </div>
