...
> 🕐 **Last audited:** Thu, 23 Apr 2026 12:32:59 GMT

#### Desktop

| Tested Route                               | Performance                                                                              | FCP   | LCP   | TBT   | CLS | Speed Index |
| :----------------------------------------- | :--------------------------------------------------------------------------------------- | :---- | :---- | :---- | :-- | :---------- |
| `/`                                        | ![Lighthouse 99](https://img.shields.io/badge/lighthouse-99-success?style=flat-square)   | 0.3 s | 0.9 s | 40 ms | 0   | 0.6 s       |
| `/blog`                                    | ![Lighthouse 100](https://img.shields.io/badge/lighthouse-100-success?style=flat-square) | 0.3 s | 0.8 s | 0 ms  | 0   | 0.6 s       |
| `/blog/2025_12_19_xpro1`                   | ![Lighthouse 94](https://img.shields.io/badge/lighthouse-94-success?style=flat-square)   | 0.2 s | 1.6 s | 20 ms | 0   | 1.0 s       |
| `/blog/2025_12_22_aftersun_paris_texas`    | ![Lighthouse 94](https://img.shields.io/badge/lighthouse-94-success?style=flat-square)   | 0.3 s | 1.6 s | 10 ms | 0   | 1.0 s       |
| `/blog/2026_01_10_plushies`                | ![Lighthouse 91](https://img.shields.io/badge/lighthouse-91-success?style=flat-square)   | 0.3 s | 1.9 s | 50 ms | 0   | 1.0 s       |
| `/blog/2026_02_10_synecdoche_truman`       | ![Lighthouse 94](https://img.shields.io/badge/lighthouse-94-success?style=flat-square)   | 0.3 s | 1.5 s | 20 ms | 0   | 1.0 s       |
| `/blog/9_m11d`                             | ![Lighthouse 93](https://img.shields.io/badge/lighthouse-93-success?style=flat-square)   | 0.3 s | 1.7 s | 70 ms | 0   | 1.3 s       |
...
| `/gallery`                                 | ![Lighthouse 100](https://img.shields.io/badge/lighthouse-100-success?style=flat-square) | 0.3 s | 0.8 s | 0 ms  | 0   | 0.7 s       |
| `/gallery/2023_07_07_splash_of_red`        | ![Lighthouse 97](https://img.shields.io/badge/lighthouse-97-success?style=flat-square)   | 0.2 s | 1.2 s | 0 ms  | 0   | 1.0 s       |
| `/gallery/2023_10_06_against_giants`       | ![Lighthouse 98](https://img.shields.io/badge/lighthouse-98-success?style=flat-square)   | 0.2 s | 1.1 s | 0 ms  | 0   | 0.9 s       |
| `/gallery/2023_11_18_dusk_impressions`     | ![Lighthouse 98](https://img.shields.io/badge/lighthouse-98-success?style=flat-square)   | 0.3 s | 1.2 s | 0 ms  | 0   | 0.9 s       |
| `/gallery/2024_01_06_hehuanshan`           | ![Lighthouse 98](https://img.shields.io/badge/lighthouse-98-success?style=flat-square)   | 0.2 s | 1.1 s | 0 ms  | 0   | 0.9 s       |
...
| `/linktree`                                | ![Lighthouse 100](https://img.shields.io/badge/lighthouse-100-success?style=flat-square) | 0.3 s | 0.8 s | 0 ms  | 0   | 0.5 s       |
...
| `/projects`                                | ![Lighthouse 100](https://img.shields.io/badge/lighthouse-100-success?style=flat-square) | 0.3 s | 0.8 s | 0 ms  | 0   | 0.7 s       |
...
| `/projects/2025_03_08_sitcon_keynote`      | ![Lighthouse 96](https://img.shields.io/badge/lighthouse-96-success?style=flat-square)   | 0.3 s | 1.3 s | 10 ms | 0   | 1.2 s       |
...
| `/projects/2025_08_04_debate`              | ![Lighthouse 97](https://img.shields.io/badge/lighthouse-97-success?style=flat-square)   | 0.3 s | 1.2 s | 50 ms | 0   | 1.2 s       |
| `/uses`                                    | ![Lighthouse 100](https://img.shields.io/badge/lighthouse-100-success?style=flat-square) | 0.3 s | 0.8 s | 0 ms  | 0   | 0.6 s       |
