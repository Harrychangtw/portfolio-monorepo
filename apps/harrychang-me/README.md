...
> 🕐 **Last audited:** Tue, 28 Apr 2026 07:16:28 GMT
...
| `/blog/2025_12_19_xpro1`                   | ![Lighthouse 93](https://img.shields.io/badge/lighthouse-93-success?style=flat-square)   | 0.3 s | 1.7 s | 10 ms | 0   | 1.4 s       |
...
| `/blog/2026_01_10_plushies`                | ![Lighthouse 91](https://img.shields.io/badge/lighthouse-91-success?style=flat-square)   | 0.3 s | 1.9 s | 10 ms | 0   | 1.1 s       |
| `/blog/2026_02_10_synecdoche_truman`       | ![Lighthouse 98](https://img.shields.io/badge/lighthouse-98-success?style=flat-square)   | 0.3 s | 1.1 s | 0 ms  | 0   | 1.0 s       |
| `/blog/9_m11d`                             | ![Lighthouse 97](https://img.shields.io/badge/lighthouse-97-success?style=flat-square)   | 0.3 s | 1.2 s | 10 ms | 0   | 1.1 s       |
| `/cv`                                      | ![Lighthouse 100](https://img.shields.io/badge/lighthouse-100-success?style=flat-square) | 0.3 s | 0.8 s | 0 ms  | 0   | 0.4 s       |
| `/design`                                  | ![Lighthouse 95](https://img.shields.io/badge/lighthouse-95-success?style=flat-square)   | 0.3 s | 1.5 s | 50 ms | 0   | 0.8 s       |
| `/gallery`                                 | ![Lighthouse 99](https://img.shields.io/badge/lighthouse-99-success?style=flat-square)   | 0.3 s | 0.8 s | 20 ms | 0   | 0.7 s       |
| `/gallery/2023_07_07_splash_of_red`        | ![Lighthouse 97](https://img.shields.io/badge/lighthouse-97-success?style=flat-square)   | 0.3 s | 1.2 s | 30 ms | 0   | 1.1 s       |
...
| `/gallery/2026_02_08_italy_mountain`       | ![Lighthouse 97](https://img.shields.io/badge/lighthouse-97-success?style=flat-square)   | 0.3 s | 1.2 s | 10 ms | 0   | 0.7 s       |
...
| `/projects/2024_08_19_classics_reimagined` | ![Lighthouse 97](https://img.shields.io/badge/lighthouse-97-success?style=flat-square)   | 0.2 s | 1.1 s | 10 ms | 0   | 1.1 s       |
...
| `/projects/2025_04_12_portfolio`           | ![Lighthouse 97](https://img.shields.io/badge/lighthouse-97-success?style=flat-square)   | 0.3 s | 1.3 s | 10 ms | 0   | 1.1 s       |
| `/projects/2025_08_04_debate`              | ![Lighthouse 97](https://img.shields.io/badge/lighthouse-97-success?style=flat-square)   | 0.3 s | 1.3 s | 20 ms | 0   | 1.1 s       |
