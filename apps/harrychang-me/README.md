...
> 🕐 **Last audited:** Sat, 02 May 2026 03:20:53 GMT  
...
| Tested Route                               | Performance                                                                            | FCP   | LCP   | TBT   | CLS | Speed Index |
| :----------------------------------------- | :------------------------------------------------------------------------------------- | :---- | :---- | :---- | :-- | :---------- |
| `/`                                        | ![Lighthouse 97](https://img.shields.io/badge/lighthouse-97-success?style=flat-square) | 0.5 s | 1.2 s | 40 ms | 0   | 1.0 s       |
| `/blog`                                    | ![Lighthouse 95](https://img.shields.io/badge/lighthouse-95-success?style=flat-square) | 0.5 s | 1.5 s | 0 ms  | 0   | 1.0 s       |
| `/blog/2025_12_19_xpro1`                   | ![Lighthouse 92](https://img.shields.io/badge/lighthouse-92-success?style=flat-square) | 0.5 s | 1.6 s | 10 ms | 0   | 1.5 s       |
| `/blog/2025_12_22_aftersun_paris_texas`    | ![Lighthouse 92](https://img.shields.io/badge/lighthouse-92-success?style=flat-square) | 0.5 s | 1.6 s | 0 ms  | 0   | 1.5 s       |
| `/blog/2026_01_10_plushies`                | ![Lighthouse 90](https://img.shields.io/badge/lighthouse-90-success?style=flat-square) | 0.5 s | 1.9 s | 0 ms  | 0   | 1.6 s       |
| `/blog/2026_02_10_synecdoche_truman`       | ![Lighthouse 93](https://img.shields.io/badge/lighthouse-93-success?style=flat-square) | 0.5 s | 1.6 s | 0 ms  | 0   | 1.5 s       |
...
| `/design`                                  | ![Lighthouse 92](https://img.shields.io/badge/lighthouse-92-success?style=flat-square) | 0.5 s | 1.8 s | 0 ms  | 0   | 1.2 s       |
| `/gallery`                                 | ![Lighthouse 94](https://img.shields.io/badge/lighthouse-94-success?style=flat-square) | 0.5 s | 1.6 s | 0 ms  | 0   | 1.2 s       |
| `/gallery/2023_07_07_splash_of_red`        | ![Lighthouse 95](https://img.shields.io/badge/lighthouse-95-success?style=flat-square) | 0.5 s | 1.4 s | 0 ms  | 0   | 1.3 s       |
| `/gallery/2023_10_06_against_giants`       | ![Lighthouse 95](https://img.shields.io/badge/lighthouse-95-success?style=flat-square) | 0.5 s | 1.4 s | 0 ms  | 0   | 1.2 s       |
| `/gallery/2023_11_18_dusk_impressions`     | ![Lighthouse 95](https://img.shields.io/badge/lighthouse-95-success?style=flat-square) | 0.5 s | 1.4 s | 0 ms  | 0   | 1.3 s       |
| `/gallery/2024_01_06_hehuanshan`           | ![Lighthouse 96](https://img.shields.io/badge/lighthouse-96-success?style=flat-square) | 0.5 s | 1.4 s | 0 ms  | 0   | 1.2 s       |
| `/gallery/2026_02_08_italy_mountain`       | ![Lighthouse 94](https://img.shields.io/badge/lighthouse-94-success?style=flat-square) | 0.5 s | 1.5 s | 0 ms  | 0   | 1.3 s       |
...
| `/manifesto`                               | ![Lighthouse 98](https://img.shields.io/badge/lighthouse-98-success?style=flat-square) | 0.5 s | 1.1 s | 0 ms  | 0   | 1.0 s       |
| `/paper-reading`                           | ![Lighthouse 98](https://img.shields.io/badge/lighthouse-98-success?style=flat-square) | 0.5 s | 1.2 s | 0 ms  | 0   | 0.8 s       |
| `/projects`                                | ![Lighthouse 94](https://img.shields.io/badge/lighthouse-94-success?style=flat-square) | 0.5 s | 1.5 s | 0 ms  | 0   | 1.3 s       |
| `/projects/2024_08_19_classics_reimagined` | ![Lighthouse 92](https://img.shields.io/badge/lighthouse-92-success?style=flat-square) | 0.5 s | 1.6 s | 0 ms  | 0   | 1.7 s       |
| `/projects/2024_09_23_chingshin_rag`       | ![Lighthouse 94](https://img.shields.io/badge/lighthouse-94-success?style=flat-square) | 0.5 s | 1.4 s | 0 ms  | 0   | 1.5 s       |
| `/projects/2025_03_08_sitcon_keynote`      | ![Lighthouse 94](https://img.shields.io/badge/lighthouse-94-success?style=flat-square) | 0.5 s | 1.4 s | 10 ms | 0   | 1.4 s       |
| `/projects/2025_04_12_portfolio`           | ![Lighthouse 94](https://img.shields.io/badge/lighthouse-94-success?style=flat-square) | 0.5 s | 1.4 s | 0 ms  | 0   | 1.5 s       |
| `/projects/2025_08_04_debate`              | ![Lighthouse 94](https://img.shields.io/badge/lighthouse-94-success?style=flat-square) | 0.5 s | 1.4 s | 10 ms | 0   | 1.5 s       |
| `/uses`                                    | ![Lighthouse 94](https://img.shields.io/badge/lighthouse-94-success?style=flat-square) | 0.5 s | 1.5 s | 0 ms  | 0   | 1.3 s       |
