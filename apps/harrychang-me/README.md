...
> 🕐 **Last audited:** Wed, 29 Apr 2026 10:19:29 GMT
...
| `/blog/2025_12_19_xpro1`                   | ![Lighthouse 93](https://img.shields.io/badge/lighthouse-93-success?style=flat-square)   | 0.3 s | 1.7 s | 30 ms | 0   | 1.1 s       |
| `/blog/2025_12_22_aftersun_paris_texas`    | ![Lighthouse 94](https://img.shields.io/badge/lighthouse-94-success?style=flat-square)   | 0.3 s | 1.7 s | 10 ms | 0   | 0.9 s       |
...
| `/design`                                  | ![Lighthouse 96](https://img.shields.io/badge/lighthouse-96-success?style=flat-square)   | 0.3 s | 1.4 s | 0 ms  | 0   | 0.7 s       |
| `/gallery`                                 | ![Lighthouse 99](https://img.shields.io/badge/lighthouse-99-success?style=flat-square)   | 0.3 s | 0.8 s | 10 ms | 0   | 0.8 s       |
| `/gallery/2023_07_07_splash_of_red`        | ![Lighthouse 97](https://img.shields.io/badge/lighthouse-97-success?style=flat-square)   | 0.3 s | 1.2 s | 20 ms | 0   | 1.1 s       |
...
| `/gallery/2026_02_08_italy_mountain`       | ![Lighthouse 97](https://img.shields.io/badge/lighthouse-97-success?style=flat-square)   | 0.2 s | 1.3 s | 0 ms  | 0   | 0.7 s       |
...
| `/projects/2024_08_19_classics_reimagined` | ![Lighthouse 96](https://img.shields.io/badge/lighthouse-96-success?style=flat-square)   | 0.3 s | 1.3 s | 10 ms | 0   | 1.3 s       |
...
| `/projects/2025_04_12_portfolio`           | ![Lighthouse 97](https://img.shields.io/badge/lighthouse-97-success?style=flat-square)   | 0.3 s | 1.2 s | 20 ms | 0   | 1.0 s       |
| `/projects/2025_08_04_debate`              | ![Lighthouse 96](https://img.shields.io/badge/lighthouse-96-success?style=flat-square)   | 0.3 s | 1.3 s | 10 ms | 0   | 1.3 s       |
