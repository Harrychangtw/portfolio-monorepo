...
> 🕐 **Last audited:** Sat, 02 May 2026 07:25:52 GMT
...
| `/blog/2025_12_22_aftersun_paris_texas`    | ![Lighthouse 95](https://img.shields.io/badge/lighthouse-95-success?style=flat-square)   | 0.3 s | 1.4 s | 20 ms | 0   | 0.9 s       |
| `/blog/2026_01_10_plushies`                | ![Lighthouse 93](https://img.shields.io/badge/lighthouse-93-success?style=flat-square)   | 0.3 s | 1.7 s | 0 ms  | 0   | 0.8 s       |
| `/blog/2026_02_10_synecdoche_truman`       | ![Lighthouse 96](https://img.shields.io/badge/lighthouse-96-success?style=flat-square)   | 0.3 s | 1.4 s | 30 ms | 0   | 1.0 s       |
| `/blog/9_m11d`                             | ![Lighthouse 95](https://img.shields.io/badge/lighthouse-95-success?style=flat-square)   | 0.3 s | 1.5 s | 30 ms | 0   | 1.1 s       |
...
| `/gallery`                                 | ![Lighthouse 97](https://img.shields.io/badge/lighthouse-97-success?style=flat-square)   | 0.3 s | 1.2 s | 10 ms | 0   | 0.8 s       |
...
| `/gallery/2026_02_08_italy_mountain`       | ![Lighthouse 98](https://img.shields.io/badge/lighthouse-98-success?style=flat-square)   | 0.3 s | 1.1 s | 10 ms | 0   | 0.7 s       |
...
> 🕐 **Last audited:** Sat, 02 May 2026 10:28:50 GMT  
...
| `/blog/2025_12_19_xpro1`                   | ![Lighthouse 92](https://img.shields.io/badge/lighthouse-92-success?style=flat-square) | 0.5 s | 1.6 s | 10 ms | 0   | 1.6 s       |
| `/blog/2025_12_22_aftersun_paris_texas`    | ![Lighthouse 92](https://img.shields.io/badge/lighthouse-92-success?style=flat-square) | 0.5 s | 1.7 s | 0 ms  | 0   | 1.5 s       |
...
| `/blog/2026_02_10_synecdoche_truman`       | ![Lighthouse 92](https://img.shields.io/badge/lighthouse-92-success?style=flat-square) | 0.5 s | 1.7 s | 10 ms | 0   | 1.6 s       |
| `/blog/9_m11d`                             | ![Lighthouse 91](https://img.shields.io/badge/lighthouse-91-success?style=flat-square) | 0.5 s | 1.7 s | 20 ms | 0   | 1.7 s       |
...
| `/gallery`                                 | ![Lighthouse 93](https://img.shields.io/badge/lighthouse-93-success?style=flat-square) | 0.5 s | 1.6 s | 0 ms  | 0   | 1.4 s       |
| `/gallery/2023_07_07_splash_of_red`        | ![Lighthouse 95](https://img.shields.io/badge/lighthouse-95-success?style=flat-square) | 0.5 s | 1.4 s | 0 ms  | 0   | 1.4 s       |
...
| `/gallery/2024_01_06_hehuanshan`           | ![Lighthouse 95](https://img.shields.io/badge/lighthouse-95-success?style=flat-square) | 0.5 s | 1.4 s | 10 ms | 0   | 1.2 s       |
| `/gallery/2026_02_08_italy_mountain`       | ![Lighthouse 93](https://img.shields.io/badge/lighthouse-93-success?style=flat-square) | 0.5 s | 1.6 s | 0 ms  | 0   | 1.4 s       |
| `/graph`                                   | ![Lighthouse 98](https://img.shields.io/badge/lighthouse-98-success?style=flat-square) | 0.5 s | 1.1 s | 0 ms  | 0   | 1.2 s       |
...
| `/paper-reading`                           | ![Lighthouse 97](https://img.shields.io/badge/lighthouse-97-success?style=flat-square) | 0.5 s | 1.2 s | 0 ms  | 0   | 1.0 s       |
...
| `/projects/2024_09_23_chingshin_rag`       | ![Lighthouse 94](https://img.shields.io/badge/lighthouse-94-success?style=flat-square) | 0.6 s | 1.4 s | 0 ms  | 0   | 1.5 s       |
| `/projects/2025_03_08_sitcon_keynote`      | ![Lighthouse 93](https://img.shields.io/badge/lighthouse-93-success?style=flat-square) | 0.5 s | 1.5 s | 0 ms  | 0   | 1.5 s       |
...
| `/projects/2025_08_04_debate`              | ![Lighthouse 94](https://img.shields.io/badge/lighthouse-94-success?style=flat-square) | 0.5 s | 1.4 s | 0 ms  | 0   | 1.6 s       |
