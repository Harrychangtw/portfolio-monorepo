...
> 🕐 **Last audited:** Mon, 30 Mar 2026 07:02:35 GMT
...
| `/blog/9_m11d` | ![Lighthouse 94](https://img.shields.io/badge/lighthouse-94-success?style=flat-square) | 0.3 s | 1.5 s | 0 ms | 0 | 1.2 s |
| `/cv` | ![Lighthouse 99](https://img.shields.io/badge/lighthouse-99-success?style=flat-square) | 0.3 s | 0.8 s | 0 ms | 0 | 0.5 s |
| `/design` | ![Lighthouse 96](https://img.shields.io/badge/lighthouse-96-success?style=flat-square) | 0.3 s | 1.4 s | 0 ms | 0 | 0.8 s |
