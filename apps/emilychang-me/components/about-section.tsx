      ...
      <div className="container min-h-[900px] md:min-h-[800px] py-16 md:py-24 relative">
        ...
        <div className="hidden md:grid grid-cols-12 gap-x-12 relative z-10 pointer-events-none h-full">
          ...
          <div className="col-span-4 flex flex-col justify-start pt-10 text-left pointer-events-auto">
            ...
            <div className="font-body text-primary space-y-5 max-w-md leading-relaxed text-[15px]">
              <p>
                This website is a collection of my past works—oil paintings,
                graphic design pieces, sketches, and everything in between.
              </p>
              <p>
                My interest in graphic design first took shape during my years
                at Xue Xue Institute, where I was encouraged to explore visual
                communication in ways that felt playful yet intentional.
                Painting, on the other hand, has been with me for as long as I
                can remember; it’s the language I grew up speaking before I even
                knew what “art” meant.
              </p>
              <p>
                Outside of creating, I love watching films and exploring new
                food spots. (I’m unreasonably passionate about crudo sauces.)
              </p>
              <p>
                I am currently studying Textiles & Fashion Design at Fu Jen
                Catholic University, driven by my curiosity for fashion and how
                it intertwines material, form, and identity.
              </p>
              <p>
                This site is both an archive of where I’ve been and a glimpse
                into where I hope my work will go.
              </p>
            </div>
          </div>
          ...
          <div className="col-span-4 text-center flex flex-col justify-center items-center opacity-50 hover:opacity-100 transition-opacity duration-500 pointer-events-none">
            <div>
              <h1 className="font-heading italic text-3xl lg:text-3xl font-medium">
                Emily Chang
              </h1>
              <p className="font-body text-secondary mt-3 tracking-wide">
          ...
          <div className="col-span-4 flex flex-col justify-start pt-10 space-y-8 text-right pointer-events-auto">
            ...
            <div>
              ...
              <div className="space-y-3">
                <InfoEntry
                  primary="Current"
                  secondary="Fu Jen Catholic University (Textiles & Fashion)"
                />
                <InfoEntry
                  primary="2021 - 2024"
                  secondary="Taipei Xue Xue Institute"
                />
                <InfoEntry
                  primary="2020 - 2021"
                  secondary="National Taipei University of Business"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <InfoEntry
                  primary="2023"
                  secondary="Story Wear Joint Exhibition"
                />
                <InfoEntry
                  primary="112 Academic Year"
                  secondary="Taipei City Student Art Merit Award"
                />
                <InfoEntry
                  primary="111 Term 1 & 2"
                  secondary="Student Showcase"
                />
              </div>
            </div>
        ...
        <div className="md:hidden relative z-10 pb-20">
          ...
          <div className="text-center pt-[420px] mb-16">
            <h1 className="font-heading italic text-3xl font-medium">
              Emily Chang
            </h1>
          ...
          <div className="mb-16">
            ...
            <div className="font-body text-primary space-y-4 mt-4">
              ...
              <p>
                My interest in graphic design first took shape during my years
                at xue xue institute. Painting, on the other hand, has been with
              ...
              <p>
                I am currently studying Textiles & Fashion Design at Fu Jen
                Catholic University. This site is both an archive of where I’ve
                been and a glimpse into where I hope my work will go.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col space-y-12">
            <div>
              ...
              <div className="space-y-4 mt-4">
                <InfoEntry
                  primary="Current"
                  secondary="Fu Jen Catholic University"
                />
                <InfoEntry
                  primary="2021 - 2024"
                  secondary="Taipei Xue Xue Institute"
