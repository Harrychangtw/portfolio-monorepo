...
const socialAndResourceLinks = [
  ...
  {
    id: "art_instagram",
    name: siteConfig.social.artInstagram.name,
    href: siteConfig.social.artInstagram.url,
  },
  {
    id: "personal_instagram",
    name: siteConfig.social.personalInstagram.name,
    href: siteConfig.social.personalInstagram.url,
  },
  {
    id: "music",
    name: siteConfig.social.spotify.name,
    href: siteConfig.social.spotify.url,
  },
];
              ...
              <div className="block mb-20">
                ...
                >
                  <Image
                    ...
                    style={{
                      width: "auto",
                      height: `${siteConfig.media.footerIconDimensions.displayHeight}px`,
                    }}
                  />
                ...
                <div className="col-span-1 md:pr-8">
                  ...
                  <ul className="space-y-3">
                    {socialAndResourceLinks.map((link) => (
                      <li key={link.id}>
                        <motion.div
                          whileHover={{ y: UI.motion.hoverLift }}
