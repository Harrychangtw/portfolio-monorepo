...
> 🕐 **Last audited:** Thu, 07 May 2026 11:41:39 GMT  
...
| :----------- | :--------------------------------------------------------------------------------------- | :---- | :---- | :------- | :-- | :---------- |
| `/`          | ![Lighthouse 58](https://img.shields.io/badge/lighthouse-58-important?style=flat-square) | 0.5 s | 1.7 s | 3,870 ms | 0   | 2.4 s       |
| `/linktree`  | ![Lighthouse 93](https://img.shields.io/badge/lighthouse-93-success?style=flat-square)   | 0.5 s | 1.8 s | 40 ms    | 0   | 0.6 s       |

#### Mobile (Production Deployment)

| Tested Route | Performance                                                                              | FCP   | LCP   | TBT        | CLS | Speed Index |
| :----------- | :--------------------------------------------------------------------------------------- | :---- | :---- | :--------- | :-- | :---------- |
| `/`          | ![Lighthouse 42](https://img.shields.io/badge/lighthouse-42-critical?style=flat-square)  | 1.7 s | 9.0 s | 143,280 ms | 0   | 4.6 s       |
| `/linktree`  | ![Lighthouse 65](https://img.shields.io/badge/lighthouse-65-important?style=flat-square) | 1.7 s | 9.3 s | 380 ms     | 0   | 2.0 s       |
