...
> 🕐 **Last audited:** Thu, 07 May 2026 07:59:39 GMT  
...
| :----------- | :--------------------------------------------------------------------------------------- | :---- | :---- | :------- | :-- | :---------- |
| `/`          | ![Lighthouse 58](https://img.shields.io/badge/lighthouse-58-important?style=flat-square) | 0.5 s | 1.7 s | 7,210 ms | 0   | 2.5 s       |
| `/linktree`  | ![Lighthouse 94](https://img.shields.io/badge/lighthouse-94-success?style=flat-square)   | 0.5 s | 1.7 s | 40 ms    | 0   | 0.5 s       |

#### Mobile (Production Deployment)

| Tested Route | Performance                                                                              | FCP   | LCP   | TBT        | CLS | Speed Index |
| :----------- | :--------------------------------------------------------------------------------------- | :---- | :---- | :--------- | :-- | :---------- |
| `/`          | ![Lighthouse 42](https://img.shields.io/badge/lighthouse-42-critical?style=flat-square)  | 1.7 s | 9.2 s | 145,060 ms | 0   | 4.6 s       |
| `/linktree`  | ![Lighthouse 63](https://img.shields.io/badge/lighthouse-63-important?style=flat-square) | 1.7 s | 9.4 s | 440 ms     | 0   | 1.7 s       |
