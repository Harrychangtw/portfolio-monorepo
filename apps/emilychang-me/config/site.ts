...
export const siteConfig = {
  ...
  author: {
    ...
    description:
      "Emily Chang explores the intersection of design, art, and creative expression",
  },
  ...
  metadata: {
    ...
    description:
      "Emily Chang explores the intersection of design, art, and creative expression. Explore her portfolio of design work, creations, and artistic endeavors.",
    keywords: [
      "Emily Chang",
      "portfolio",
      "design",
