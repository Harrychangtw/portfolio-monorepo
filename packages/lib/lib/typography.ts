...
export const fontSizes: FontSize[] = [
  {
    ...
    value: "0.75rem",
    remValue: 0.75,
    usage: "Small labels, captions, metadata",
  },
  {
    name: "text-sm",
    value: "0.875rem",
    remValue: 0.875,
    usage: "Secondary text, form labels, small UI elements",
  },
  {
    name: "text-base",
    value: "1rem",
    remValue: 1,
    usage: "Body text, standard UI text, navigation links",
  },
  {
    name: "text-lg",
    value: "1.125rem",
    remValue: 1.125,
    usage: "Emphasized body text, section headings",
  },
  {
    name: "text-xl",
    value: "1.25rem",
    remValue: 1.25,
    usage: "Large body text, subheadings, menu items",
  },
  {
    name: "text-2xl",
    value: "1.5rem",
    remValue: 1.5,
    usage: "H3 headings, card titles",
  },
  {
    name: "text-3xl",
    value: "1.875rem",
  ...
  },
  {
    ...
    value: "2.25rem",
    remValue: 2.25,
    usage: "H1 headings, hero titles",
  },
  {
    name: "text-5xl",
    value: "3rem",
    remValue: 3,
    usage: "Large hero text, feature headings",
  },
  {
    name: "text-6xl",
    value: "3.75rem",
    remValue: 3.75,
    usage: "Extra large display text",
  },
  {
    name: "text-7xl",
    value: "4.5rem",
    remValue: 4.5,
    usage: "Massive display text (rarely used)",
  },
  {
    name: "text-8xl",
    value: "6rem",
    remValue: 6,
    usage: "Ultra large display text (rarely used)",
  },
];
...
export const fontWeights: FontWeight[] = [
  { name: "Thin", value: 100, usage: "Minimal emphasis, decorative text" },
  {
    name: "Extra Light",
    value: 200,
    usage: "Subtle emphasis, secondary content",
  },
  ...
  { name: "Regular", value: 400, usage: "Standard body text, default weight" },
  {
    name: "Medium",
    value: 500,
    usage: "Emphasized text, active states, metadata",
  },
  {
    name: "Semi Bold",
    value: 600,
    usage: "Subheadings, important UI elements",
  },
  {
    name: "Bold",
    value: 700,
    usage: "Headings, strong emphasis, calls to action",
  },
];
...
export const letterSpacings = [
  {
    name: "Tighter",
    value: "-0.05em",
    usage: "Large display text (tracking-tighter)",
  },
  ...
  { name: "Wider", value: "0.05em", usage: "Spaced headings (tracking-wider)" },
  {
    name: "Widest",
    value: "0.1em",
    usage: "Maximum spacing (tracking-widest)",
  },
];
...
export const lineHeights = [
  {
    name: "None",
    value: "1",
    usage: "Display text, tight layouts (leading-none)",
  },
  ...
  { name: "Normal", value: "1.5", usage: "Body text (leading-normal)" },
  {
    name: "Relaxed",
    value: "1.625",
    usage: "Comfortable reading (leading-relaxed)",
  },
